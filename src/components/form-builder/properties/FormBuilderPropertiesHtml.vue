...
<template>
  <el-form :model="fieldProperties" :rules="rules" :label-position="labelPosition" ref="fieldProperties">
    ...
    <el-form-item label="Html Content">
      <el-input :rows="16" type="textarea" v-model="manageFormBuilderStore.activeField.htmlContent">
        {{ manageFormBuilderStore.activeField.htmlContent }}
      </el-input>
    </el-form-item>
