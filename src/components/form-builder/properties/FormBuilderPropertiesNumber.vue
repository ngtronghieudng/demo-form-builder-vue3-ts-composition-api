...
<template>
  <el-form :model="fieldProperties" :rules="rules" :label-position="labelPosition" ref="fieldProperties">
    ...
    <el-form-item label="Value">
      <base-input v-model="manageFormBuilderStore.activeField.value" type="number" />
    </el-form-item>

    <el-form-item label="Min">
      <base-input v-model="manageFormBuilderStore.activeField.min" type="number" />
    </el-form-item>

    <el-form-item label="Max">
      <base-input v-model="manageFormBuilderStore.activeField.max" type="number" />
    </el-form-item>

    <el-form-item label="Step">
      <base-input v-model="manageFormBuilderStore.activeField.step" type="number" />
    </el-form-item>
